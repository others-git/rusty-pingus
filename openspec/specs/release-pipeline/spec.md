...
Defines the GitHub Actions release pipeline that builds cross-platform binaries and publishes them as GitHub Release assets whenever a version tag is pushed.
