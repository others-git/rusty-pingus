...
Defines behavior for auto-generating a default configuration file when none exists at startup, including user notification via logs and Windows tray tooltip.
