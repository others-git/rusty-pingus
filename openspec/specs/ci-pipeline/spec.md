...
Defines the GitHub Actions continuous integration pipeline that validates every pull request and push to `main` by building and testing the Rust codebase.
