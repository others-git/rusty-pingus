...
Defines the scheduling subsystem responsible for independently timing and dispatching per-monitor probe tasks, handling graceful shutdown, error isolation, and scalability.
