...
Defines the visual design system for the web UI: CDN library dependencies, dark-mode color palette, typography, and reusable UI components such as animated status indicators and uptime gauge rings.
